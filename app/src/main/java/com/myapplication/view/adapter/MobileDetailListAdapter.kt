...
class MobileDetailListAdapter(
    private val itemListListener: ItemListClick,
    private val favButListener: ItemListClick.OnClickFavoriteButton
) : RecyclerView.Adapter<MobileDetailListHolder>() {
